...
PRODUCT_PROPERTY_OVERRIDES += \
    persist.log.tag.CdmaMoSms=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.CdmaMtSms=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.DCT=$(VENDOR_LOG_LEVEL_D) \
    persist.log.tag.DCT-C-0=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.DCT-I-0=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.DCT-C-1=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.DCT-I-1=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.DC-C-1=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.DC-C-2=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.RetryManager=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.RIL-SMS=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.DupSmsFilterExt=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.ConSmsFwkExt=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.DataOnlySmsFwk=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.SpeechMessenger=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.SmsPlusCode=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.AutoRegSmsFwk=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.MGsmSMSDisp=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MSimSmsIStatus=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MSmsStorageMtr=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MSmsUsageMtr=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.Mtk_RIL_ImsSms=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MtkConSmsFwk=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MtkCsimFH=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MtkDupSmsFilter=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.MtkIccSmsIntMgr=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.RmcDcDefault=$(VENDOR_LOG_LEVEL_I) \
    ...
    persist.log.tag.powerd=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.mtkpower@1.0-impl=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.legacy_power@2.1-impl=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.power@1.3-impl=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.PowerWrap=$(VENDOR_LOG_LEVEL_I) \
    persist.log.tag.mtkperf_client=$(VENDOR_LOG_LEVEL_I) \
